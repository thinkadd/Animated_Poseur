...
/**
 * The WhitespaceFreeXMLDoc class makes our life easier. It stores all the
 * information about an XML document in a tree that's easy to navigate and
 * contains zero whitespace, which is good for XML files used for storing data,
 * since whitespace is irrelevant to such documents and simply clutters loaded
 * trees with this data.
 *
 * @author Xiufeng Yang
 * @version 1.0
 */
public class WhitespaceFreeXMLDoc {
    ...
    /**
     * Default constructor, this does not initialization. The loadDoc method is
    ...
    /**
     * Accessor method for getting the root of the tree to allow one to climb
     * the tree.
     *
     * @return The root of this tree, which would be the root of the xml
     * document.
     */
    public WhitespaceFreeXMLNode getRoot() {
        return root;
    }
     ...
     * into this doc.
     *
     * @param doc The loaded xml document with all the data that should be
    ...
    /**
     * This recursive method loads all the necessary data from the
     * nodeToLoadFrom node into the nodeToLoad node. This includes node
     * attributes and children and it recursively cascades node loading on down
     * through the tree.
     *
