...
//
//import animatedPoseur.state.AnimationStateSelectionHandler;
...
//
///**
// * The AnimatedSpriteViewer module lets one load and view sprite states and then
// * view their animation. Note that all data concerning the sprites should be
// * done via .xml files.
// *
...
//        Iterator<String> spriteTypeNamesIt = spriteTypes.keySet().iterator();
...
//
//    /**
//     * Called when the user selects a sprite type from the list, it will get all
//     * the animation states for that sprite type and load them into the combo
//     * box.
//     */
...
//        Iterator<AnimationState> it = selectedSpriteType.getAnimationStates();
//        while (it.hasNext()) {
...
//
//    /**
//     * Called when the user selects an animation state from the combo box, it
//     * will ensure this one is rendered.
//     */
...
//                AnimationState selectedState = (AnimationState) spriteStateCombobox.getSelectedItem();
//                String selectedSpriteTypeName = (String) spriteTypesList.getSelectedValue();
//                SpriteType selectedSpriteType = spriteTypes.get(selectedSpriteTypeName);
