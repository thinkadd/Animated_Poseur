...
/**
 * The WhitespaceFreeXMLNode class works hand in hand with the corresponding Doc
 * class. This class represents a single node in that XML tree. These classes
 * make our life easier when dealing with xml documents. XML documents are
 * basically trees, this organizes them formally as such.
 *
 * @author Xiufeng Yang
 * @version 1.0
 */
public class WhitespaceFreeXMLNode {
    ...
    /**
     * Constructs a node only with a name. Children, attributes, and data can be
     * added later.
     *
     ...
     */
    public Iterator<WhitespaceFreeXMLNode> getChildren() {
     ...
     *
     * @param attributeName Name of the attribute whose value is being
     * requested.
     *
    ...
    /**
     * Accessor method for getting all the attributes one at a time via an
     * iterator.
     *
     * @return An iterator for going through all the attribute names.
     */
    public Iterator<String> getAttributeNamesIterator() {
    ...
    /**
     * A search method for getting a single child node of this node that has a
     * name of type.
     *
