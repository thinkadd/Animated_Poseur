...
/**
 * This class is used for prompting the user for new dimensions for the pose.
 *
 * @author Xiufeng Yang
 * @version 1.0
 */
public class PoseDimensionsDialog extends JDialog {
    ...
    /**
     * Default constructor fully sets up the dialog for use, constructing all
     * components, laying them out, and registering all necessary event
     * handlers.
     */
    ...
    /**
     * Change the default demensions of poses, which are being rendered on the
     * canvases
     */
    public void changePoseDimensions() {
        ...
        try {
            ...
            if ((poseWidth < MIN_POSE_DIM)
                ...
                JOptionPane.showMessageDialog(PoseDimensionsDialog.this,
                        INVALID_POSE_DIM_TEXT,
                        INVALID_POSE_DIM_TITLE_TEXT,
    ...
    /**
     * Dialogs are just like frames, only with fewer capabilities and thus
     * overhead (memory requirements).
     */
    ...
    /**
     * This method constructs and lays out all the components inside this
     * dialog.
     */
    ...
    /**
     * This helper method lets us easily add components to our dialog using
     * GridBagLayout.
     *
     ...
     *
     * @param colSpan The number of columns in the grid this control will span.
     *
     * @param rowSpan The number of rows in the grid this control will span.
     */
    private void addComponent(
            Component c, int col, int row, int colSpan, int rowSpan) {
        // THIS PROVIDES INTERNAL SPACING
        Insets insets = new Insets(CONTROL_INSET,
                CONTROL_INSET, CONTROL_INSET, CONTROL_INSET);
    ...
    /**
     * This method initializes all handlers. Because there are few controls with
     * handlers in this dialog, we can simply define them here as anonymous
     * classes, meaning we define the listener classes without giving them
     * names.
     */
