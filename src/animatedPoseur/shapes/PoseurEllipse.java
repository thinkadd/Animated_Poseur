...
/**
 * This class represents an ellipse shape in the Poseur application. Note that
 * it knows how to render itself and do other important tasks that use its
 * geometry.
 *
 * @author Xiufeng Yang
 */
public class PoseurEllipse extends PoseurShape {
    ...
    /**
     * PoseurEllipse objects are constructed with their geometry, which can be
    ...
    /**
     * This static method constructs and returns a new ellipse with an x
     ...
     */
    public static PoseurEllipse factoryBuildEllipse(
            int poseSpaceX, int poseSpaceY) {

        Ellipse2D.Double ellipse =
                new Ellipse2D.Double(poseSpaceX, poseSpaceX, 0, 0);
    ...
    /**
     * This method tests if the testPoint argument is inside this ellipse. If it
    ...
    /**
     * This method makes a clone, i.e. a duplicate, of this ellipse. This is
    ...
    /**
     * This is a smarter method for moving this ellipse, it considers the pose
     ...
     * corner points for a container rectangle of this ellipse in progress.
     *
     * @param x The x-axis coordinate for the test point.
     * @param y The y-axis coordinate for the test point.
     * @return true if (x,y) would be a valid lower-right corner point of the
     * container rectangle based on where this ellipse is currently located.
     */
    @Override
    ...
    /**
     * This method helps to update the a ellipse that's being sized, testing to
    ...
    /**
     * This method helps to build a .pose file. Ellipses know what data they
     * have, so this fills in the geometryNode argument DOC element with the
     * ellipse data that would be needed to recreate it when it's loaded back
     * from the .pose (xml) file.
     *
     * @param geometryNode The node where we'll put attributes regarding the
     * geometry of this ellipse.
     */
    @Override
