 ...
 * that it knows how to render itself and do other important tasks that use its
 * geometry. The geometry for a shape like a rectangle is very different than
 * for other shapes, like a line, so we specify those differences inside this
 * class.
 *
 * @author Xiufeng Yang
 * @version 1.0
...
public class PoseurRectangle extends PoseurShape {
    ...
    /**
     * PoseurRectangle objects are constructed with their geometry, which can be
    ...
    /**
     * This static method constructs and returns a new rectangle with an x
     * location of the poseSpaceX argument, a y location of poseSpaceY, and a
     * width and height of 0.
     *
     * @param poseSpaceX The requested x value for the new, factory built
     * PoseurRectangle object.
     *
     * @param poseSpaceY The requested y value for the new, factory built
     * PoseurRectangle object.
     *
     * @return A constructed PoseurRectangle.
     */
    public static PoseurRectangle factoryBuildRectangle(
            int poseSpaceX, int poseSpaceY) {
        Rectangle2D.Double rect =
                new Rectangle2D.Double(poseSpaceX, poseSpaceY, 0, 0);
    ...
    /**
     * This method tests if the testPoint argument is inside this rectangle. If
     * it does, we return true, if not, false.
     *
    ...
    /**
     * This method makes a clone, i.e. a duplicate, of this rectangle. This is
    ...
    /**
     * This is a smarter method for moving this rectangle, it considers the pose
    ...
    /**
     * This method tests to see if the x,y arguments would be valid lower-right
     * corner points for a rectangle in progress.
     *
     * @param x The x-axis coordinate for the test point.
     *
     * @param y The y-axis coordinate for the test point.
     *
     * @return true if (x,y) would be a valid lower-right corner point based on
     * where this rectangle is currently located.
     */
    @Override
    ...
    /**
     * This method helps to update the a rectangle that's being sized, testing
     * to make sure it doesn't draw in illegal coordinates.
     *
    ...
    /**
     * This method helps to build a .pose file. Rectangles know what data they
     * have, so this fills in the geometryNode argument DOC element with the
     * rectangle data that would be needed to recreate it when it's loaded back
     * from the .pose (xml) file.
     *
