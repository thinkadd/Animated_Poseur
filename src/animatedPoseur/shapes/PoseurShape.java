...
/**
 * This abstract class provides a template for shapes to be rendered inside the
 * Poseur application.
 *
 * @author Xiufeng Yang
 * @version 1.0
...
public abstract class PoseurShape {
     ...
     */
    public BasicStroke getOutlineThickness() {
     ...
     */
    public void setOutlineThickness(BasicStroke initStroke) {
        outlineThickness = initStroke;
    }
     ...
     */
    public void setOutlineColor(Color initOutlineColor) {
     ...
     */
    public void setAlpha(int initAlpha) {
        alpha = initAlpha;
    }

    /**
     * This method renders the shapeGeometry to the g2 context using this
     * shape's line thickness, colors, and alpha values.
     *
     * @param g2 The rendering context, which could be a panel on the screen or
     * an image to be saved to a file.
     *
     * @param shapeGeometry The geometry to use for rendering.
     *
     * @param isSelected Marks if this shape is to be rendered as highlighted
     * (i.e. selected) or not.
     */
    public void renderShape(Graphics2D g2,
            Shape shapeGeometry, boolean isSelected) {
        // FILL FIRST
     ...
     * want to apply different alpha values to different shapes but use the same
     * color. But, when it comes time to render our shapes, we need the alpha
     * value, so this method creates a color that combines the colorWithoutAlpha
     * argument with this shape's alpha value. That constructed Color object is
     * then returned.
     *
     * @param colorWithoutAlpha The color to process. It does not have an alpha
     * value.
     *
    ...
    /**
     * This method tests if the testPoint argument is inside this shape. If it
     * does, we return true, if not, false.
     *
    ...
    /**
     * This method renders this shape to whatever context the g2 argument comes
     * from.
     *
    ...
    /**
     * This method makes a clone, i.e. a duplicate, of this shape. This is
     * useful for cut/copy/paste types of operations in applications.
     *
    ...
    /**
     * This method moves this shape to the x, y location without doing any error
     * checking on whether it's a good location or not.
     *
    ...
    /**
     * This is a smarter method for moving this shape, it considers the pose
     * area and prevents it from being moved off the pose area by clamping at
     * the edges.
     *
    ...
    /**
     * This method tests to see if the x,y arguments would be valid next
     * geometric valuee for a shape in progress.
     *
     * @param x The x-axis coordinate for the test point.
     *
     * @param y The y-axis coordinate for the test point.
     *
     * @return true if (x,y) would be a valid second coordinate for the shape in
     * progress based on where it is currentyl located.
     */
    public abstract boolean completesValidShape(int x, int y);

    /**
     * This method helps to update the shape that's being sized, testing to make
     * sure it doesn't draw in illegal coordinates.
     *
    ...
    /**
     * This method helps to build a .pose file. Shapes know what data they have,
     * so this fills in the geometryNode argument DOC element with the shape
