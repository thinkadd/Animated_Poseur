 ...
 * canvas and has asked to move it to the top of the canvases.
 *
 * @author Xiufeng Yang
 */
public class MoveFrontHandler implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        poseurStateManager.moveFrontSelectedItem();
    }
}