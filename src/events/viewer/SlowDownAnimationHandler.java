...
/**
 * The SlowDownAnimationHandler responds to when the user requests to slow down
 * animation. It proceeds to do just that.
 *
 * @author Xiufeng Yang
 * @version 1.0
 */
public class SlowDownAnimationHandler implements ActionListener {
    ...
    /**
     * Called when someone presses the slow down the scene button, it tells the
     * renderer to do so.
     *
